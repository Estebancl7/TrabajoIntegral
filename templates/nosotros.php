...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <a href="/TrabajoIntegral/templates/cargarArchivo.php" class="btn btn-outline-light px-2" style="text-align: center; max-width: 850px;">Comenzar Ahora!</a>                    
        ...
        <div class="container text-center bg-dark rounded shadow my-4 p-3">
            ...
            <div class="row">
                <div class="col-6 pl-5">
                    <P>Este ser&aacute el grupo de trabajo que estar&aacute a cargo del desarrollo de los proyectos a realizar durante el semestre acádemico del año 2020 de la asignatura <strong>Grafos y Lenguajes Formales</strong>.
                    </P>
                    <img src="img/Grafos.png" alt="" height="180px">
                </div>
                <div class="col-6 pt-1 pr-5">
                    <p> <em class="fas fa-check-circle"></em> Miguel Martínez Sánchez.</p>
                    ...
                    <p><em class="fas fa-check-circle"></em> Luis Rivas Sánchez.</p>
                </div>
            </div>
        </div>
    ...
    <section id="footer">
        <nav class="container-fluid  fixed-bottom p-2 mt-5 aria-label">
            <div class="container">
